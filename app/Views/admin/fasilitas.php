...
<head>
    ...
    <title>Kelola Fasilitas - Admin Hotelku</title>
...
<body style="background: #f8f9fa;">
    ...
    <div class="form-container">
        ...
        <h2 class="mb-4">
            ...
            Kelola Fasilitas - <?= esc($akomodasi['nama']) ?>
        </h2>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="/admin/fasilitas/save" method="post">
                    <?= csrf_field() ?>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="nama_fasilitas" 
                                   placeholder="Contoh: WiFi Gratis" required>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label class="form-label">Icon Font Awesome</label>
                            <input type="text" class="form-control" name="icon" 
                                   placeholder="Contoh: fa-wifi" required>
                            <small class="text-muted">
                                Lihat icon di <a href="https://fontawesome.com/icons" target="_blank">fontawesome.com</a>
                            </small>
                        </div>
        ...
        <?php else: ?>
            <?php foreach($fasilitas as $f): ?>
                <div class="fasilitas-item">
                    <div>
                        <i class="fas <?= esc($f['icon']) ?> me-2" style="color: #667eea; font-size: 20px;"></i>
                        <strong><?= esc($f['nama_fasilitas']) ?></strong>
                        <small class="text-muted ms-2">(<?= esc($f['icon']) ?>)</small>
                    </div>
                    <div>
                        ...
                        <a href="/admin/fasilitas/delete/<?= $f['id'] ?>" 
                            ...
                            <form action="/admin/fasilitas/save" method="post">
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <label class="form-label">Nama Fasilitas</label>
                                        <input type="text" class="form-control" name="nama_fasilitas" 
                                               value="<?= esc($f['nama_fasilitas']) ?>" required>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Icon</label>
                                        <input type="text" class="form-control" name="icon" 
                                               value="<?= esc($f['icon']) ?>" required>
                                    </div>
                                </div>
