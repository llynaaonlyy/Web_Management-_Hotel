...
// Home & Search Routes (Require Login)
...
$routes->get('/pemesanan/(:num)', 'Pemesanan::form/$1');
$routes->post('/pemesanan/proses', 'Pemesanan::proses');
$routes->get('/pemesanan/sukses/(:num)', 'Pemesanan::sukses/$1');

// Staff Routes (Require Login as Pegawai)
$routes->group('staff', ['filter' => 'auth'], function($routes) {
    $routes->get('dashboard', 'Staff::dashboard');
    $routes->get('pemesanan/(:num)', 'Staff::detailPemesanan/$1');
    $routes->post('update-status', 'Staff::updateStatus');
    $routes->post('update-catatan-internal', 'Staff::updateCatatanInternal');
    $routes->get('kelola-kamar', 'Staff::kelolaKamar');
    $routes->post('update-stok-kamar', 'Staff::updateStokKamar');
    $routes->post('update-status-kamar', 'Staff::updateStatusKamar');
    $routes->get('data-tamu', 'Staff::dataTamu');
    $routes->get('tamu/(:num)', 'Staff::detailTamu/$1');
});
