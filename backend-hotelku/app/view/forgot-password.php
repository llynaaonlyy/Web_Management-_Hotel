    ...
    <div class="container">
        ...
        <div id="step1" class="step active">
            <form id="form-step1">
                ...
                <div class="form-group">
                    ...
                    <input type="tel" id="noHp" placeholder="081234567890" required>
                ...
                <div class="back-link1">
                    <a href="http://localhost:8080/login">← Kembali ke Login</a>
                </div>
        ...
        <div id="step2" class="step">
            <form id="form-step2">
                ...
                <div class="back-link">
                    <a onclick="backToStep1()">← Kembali ke Step 1</a>
                </div>
            </form>
        </div>
        ...
        <div id="step3" class="step">
            <form id="form-step3">
                ...
                <div class="form-group">
                    ...
                    <div class="password-wrapper">
                        <input 
                            ...
                            required
                        >
                        <span class="password-icon" onclick="togglePassword('confirmPassword', this)">
                            <i class="bi bi-eye-slash"></i>
                        </span>
                    </div>
                </div>
                ...
                <div class="back-link">
                    <a onclick="backToStep1()">← Mulai dari awal</a>
                </div>
            </form>
        </div>
        ...
        <div id="stepSuccess" class="step">
            ...
            <h3 style="color: #4caf50; text-align: center; margin-bottom: 10px;">✓ Sandi Berhasil Diubah</h3>
